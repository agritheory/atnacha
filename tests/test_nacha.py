...
def example_entry_8():
	return ACHEntry(
		...
		amount=145330,
		individual_id_number='',
		individual_name='Anderson Enterprises',
		discretionary_data='',
		addenda_record_indicator=0,
	)
...
def test_entry_str(
	...
	output_8 = '627072000915723458745        0000145330               Anderson Enterprises    0'
...
627072000915723458745        0000145330               Anderson Enterprises    0072000910000009
...
# def test_complete_nacha_file(example_nacha_0):
# 	pass
